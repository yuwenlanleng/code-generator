...
/**
 * 
 * @ClassName: VelocityInfoUtil
 * @Description: 模板操作类
 * @author panhaicheng@gomeholdings.com
 * @date 2016年7月12日 下午1:59:50
 *
 */
public class VelocityInfoUtil {

	public static void generatorCode(String templateFile,
			Map<String, Object> contextMap, String path, String fileName) {
		// 设置模板载入路径
		...
		// 模板文件所在的路径
		// String vPath = System.getProperty("user.dir") + "\\conf";
